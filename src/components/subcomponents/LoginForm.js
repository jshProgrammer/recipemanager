        ...
        <div className="p-4">
            ...
            <div className="d-grid gap-3 mb-4">
              <button
                ...
                className="btn btn-outline-secondary d-flex align-items-center justify-content-center py-3 rounded-pill"
              >
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-3">
              ...
              <div className="d-grid">
                <button
                  type="submit"
                  className="btn backgroundGreen py-3 rounded-pill fw-medium"
                >
                  {isSignUp ? 'Sign up' : 'Log in'}
                </button>
              </div>
