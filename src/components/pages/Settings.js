...
export default function Settings() {
    ...
    const equipmentList = [
        'skimmer', 'pie form', 'glass baking pan', 'garlic press', 'meat grinder', 
        'tongs', 'bread knife', 'tajine pot', 'wire rack', 'mincing knife', 
        'cherry pitter', 'wooden skewers', 'kitchen scissors', 'blow torch', 
        'broiler pan', 'heart shaped silicone form', 'grill', 'immersion blender', 
        'baking sheet', 'oven mitt', 'pastry bag', 'palette knife', 'pizza cutter', 
        'bottle opener', 'bowl', 'pizza pan', 'candy thermometer', 'rolling pin', 
        'frying pan', 'casserole dish', 'plastic wrap', 'salad spinner', 'broiler', 
        'silicone muffin tray', 'meat tenderizer', 'edible cake image', 'measuring spoon', 
        'kitchen thermometer', 'sifter', 'muffin tray', 'chocolate mold', 'kitchen towels', 
        'potato ricer', 'silicone kugelhopf pan', 'offset spatula', 'cheesecloth', 
        'lemon squeezer', 'cake form', 'mini muffin tray', 'carving fork', 'egg slicer', 
        'ice cube tray', 'corkscrew', 'ice cream machine', 'sieve', 'kugelhopf pan', 
        'pastry brush', 'popsicle sticks', 'spatula', 'cake server', 'poultry shears', 
        'box grater', 'cupcake toppers', 'funnel', 'drinking straws', 'slotted spoon', 
        'ceramic pie form', 'pepper grinder', 'mortar and pestle', 'baster', 'melon baller', 
        'zester', 'pastry cutter', 'ziploc bags', 'aluminum foil', 'toothpicks', 'pot', 
        'baking pan', 'ladle', 'apple cutter', 'fillet knife', 'toaster', 
        ...
        'grater', 'gravy boat', 'muffin liners', 'butter knife', 'waffle iron', 
        'double boiler', 'can opener', 'mandoline', 'kitchen twine', 'juicer', 'wok', 
        'measuring cup', 'ramekin', 'airfryer', 'instant pot', 'spoon', 'dough scraper', 
        'microwave', 'roasting pan', 'pressure cooker', 'dehydrator', 'baking paper', 
        'silicone muffin liners', 'loaf pan', 'cake topper', 'dutch oven', 'baking spatula', 
        'popsicle molds', 'teapot', 'cocktail sticks', 'cleaver', 'rice cooker', 
        'bread machine', 'fork', 'ice cream scoop', 'slow cooker', 'knife', 'kitchen scale', 
        'griddle', 'frosting cake topper', 'cutting board', 'cake pop mold', 'oven', 
        'colander', 'kitchen timer', 'panini press', 'pasta machine', 'popcorn maker', 
        'lollipop sticks', 'steamer basket', 'chopsticks', 'chefs knife', 'blender', 
        'pizza stone', 'skewers', 'sauce pan', 'peeler', 'stove', 'pot holder', 
